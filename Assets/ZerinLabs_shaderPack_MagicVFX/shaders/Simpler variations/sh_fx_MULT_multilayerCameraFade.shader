Shader "zerinlabs/sh_fx_MULT_multilayerCameraFade" 
{
	Properties
	{
		...
		_MaskInv("Mask inversion", Range(0,1)) = 1
	}
		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 frag(vertexOutput IN) : COLOR
				{
					...
					float AlphaRegular = Main.a * Main.r * Mask.a * Mask.r * IN.col.a * _colorTint.a * IN.NdotV;
					...
					//fixed4 Complete = float4(AlphaInverted, AlphaInverted, AlphaInverted, Alpha);
