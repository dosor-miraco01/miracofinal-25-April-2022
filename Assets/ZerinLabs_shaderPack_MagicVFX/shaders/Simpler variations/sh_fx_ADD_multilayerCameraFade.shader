...
Shader "zerinlabs/sh_fx_ADD_multilayerCameraFade" 
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 frag(vertexOutput IN) : COLOR
				{
					...
					float Alpha = Main.a * Mask.a * IN.col.a * _colorTint.a * IN.NdotV;

					float3 Color = Main.rgb * Mask.rgb * IN.col.rgb * _colorTint.rgb * _overbright * Alpha;
