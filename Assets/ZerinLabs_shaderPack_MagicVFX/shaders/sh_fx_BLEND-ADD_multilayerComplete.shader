Shader "zerinlabs/sh_fx_BLEND-ADD_multilayerComplete"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 frag(vertexOutput IN) : COLOR
				{
					...
					Alpha = Alpha * IN.col.a * _alphaPow * IN.col.r;
					...
					Color = Color * overbright * Alpha;

					//output composite: RGB + A
					fixed4 Complete = float4(Color * IN.NdotV, Alpha * IN.NdotV);
